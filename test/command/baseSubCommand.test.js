...
describe('BaseSubCommand', () => {
  ...
  test('should create command with parameters and options', async () => {
    ...
    expect(commander.option).toHaveBeenCalledWith(
      '-c, --cipher [cipher]',
      'Which cipher algorithm to use, default to be aes-128-ctr'
    );
  ...
  test('getParameters should return formatted parameter string', () => {
    baseSubCommand = new BaseSubCommand(sampleCommandName, [
  ...
  test('fail to run validate', async () => {
    ...
    asyncValidator.prototype.validate = originalValidate;
  ...
  test('makeExamples should return formatted examples', () => {
    ...
    expect(examples).toEqual(['aelf-command get-chain-status example usage']);
  });
});
...
describe('BaseSubCommand with default params', () => {
  ...
  test('should execute action callback', () => {
    baseSubCommand = new BaseSubCommand(sampleCommandName, undefined, sampleDescription);
  ...
  test('run with no required validatorDesc', async () => {
    baseSubCommand = new BaseSubCommand(sampleCommandName, undefined, sampleDescription, sampleOptions, sampleUsage, sampleRc, {
