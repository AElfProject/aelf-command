...
You can get the default organization address which has all BP nodes inside, every proposal under `AElf.ContractNames.Parliament` can only be released when it has got over 2/3 BP nodes approve
